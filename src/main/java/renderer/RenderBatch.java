...
public class RenderBatch implements Comparable<RenderBatch> {
    ...
    // Vertex
    // ======
    // Pos                  Color                           UV Coordinates    TextId
    ...
    private int[] slots = {0, 1, 2, 3, 4, 5, 6, 7};
    ...
    public RenderBatch(int maxBatchSize, int zIndex) {
        this.zIndex = zIndex;
        shader = AssetPool.getShader("C:\\Users\\PC\\Mario\\mario\\assets\\shaders\\default.glsl");
